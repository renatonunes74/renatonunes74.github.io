...
- [estruturas de dados e algoritimos em JavaScript](https://github.com/trekhleb/javascript-algorithms/blob/master/README.pt-BR.md)

# DSA
- [algorithm-visualizer.org](algorithm-visualizer.org)

# Git
- [git-scm.co](git-scm.co)
- [coleção para .gitignore](https://github.com/github/gitignore)

# React
- [react-tutotial.app](react-tutotial.app)

# API
- [rapidapi.com/learn](rapidapi.com/learn)

# Python
- [learnpython.com](learnpython.com)

# SQL
- [sqlbolt.com](sqlbolt.com)

# Web3
- [learnweb3.io](learnweb3.io)

# Terminal
- [aprendendo a usar a linha de comando](https://github.com/jlevy/the-art-of-command-line/blob/master/README-pt.md)

# Outros
- [mapas conceituais para aprender diferentes linguagens de programação](https://roadmap.sh/)
